      ...
      >
        ...
        >
          <View style={styles.headerContainer}>
            <Text style={[styles.welcomeText, { fontFamily: 'SpaceGrotesk_700Bold', color: colors.text }]}>Reset Password</Text>
            <Text style={[styles.subtitleText, { fontFamily: 'SpaceGrotesk_400Regular', color: colors.textSecondary }]}>Enter your email to receive a reset link.</Text>
          </View>
